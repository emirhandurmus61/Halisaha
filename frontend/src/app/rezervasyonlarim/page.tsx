    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-green-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {filteredReservations.length === 0 ? (
          <div className="bg-white rounded-2xl shadow-xl p-12 text-center border border-gray-100">
            ...
            <Link href="/sahalar">
              <button className="px-4 sm:px-6 py-2.5 sm:py-3 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-xl font-semibold hover:shadow-lg transition-all text-sm sm:text-base">
                Sahalara Gözat
              </button>
            </Link>
          </div>
                      ...
                      <div className="flex flex-col gap-2 w-full lg:w-auto lg:flex-row lg:flex-wrap">
                        {!isPast && reservation.isOwner && (reservation.status === 'confirmed' || reservation.status === 'pending') && (
                          <>
                            <button
                              ...
                              className="w-full lg:w-auto px-3 sm:px-4 py-2 sm:py-2.5 border-2 border-green-200 text-green-600 rounded-xl font-semibold hover:bg-green-50 transition-all flex items-center justify-center gap-2 text-xs sm:text-sm"
                            >
                            ...
                            <button
                              ...
                              className="w-full lg:w-auto px-3 sm:px-4 py-2 sm:py-2.5 border-2 border-blue-200 text-blue-600 rounded-xl font-semibold hover:bg-blue-50 transition-all flex items-center justify-center gap-2 text-xs sm:text-sm relative"
                            >
                              <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            {canCancel && (
                              <button
                                ...
                                className="w-full lg:w-auto px-3 sm:px-4 py-2 sm:py-2.5 border-2 border-red-200 text-red-600 rounded-xl font-semibold hover:bg-red-50 transition-all flex items-center justify-center gap-2 text-xs sm:text-sm"
                              >
                                <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        {isPast && reservation.isOwner && (
                          <button
                            ...
                            className="w-full lg:w-auto px-3 sm:px-4 py-2 sm:py-2.5 bg-gradient-to-r from-purple-500 to-indigo-600 text-white rounded-xl font-semibold hover:shadow-lg transition-all flex items-center justify-center gap-2 text-xs sm:text-sm"
                          >
                            <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        {reservation.venue?.id && (
                          <Link href={`/sahalar/${reservation.venue.id}`} className="w-full lg:w-auto">
                            <button className="w-full px-3 sm:px-4 py-2 sm:py-2.5 border-2 border-gray-200 text-gray-700 rounded-xl font-semibold hover:bg-gray-50 transition-all flex items-center justify-center gap-2 text-xs sm:text-sm">
                              <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {showRatingModal && ratingReservation && (
        <PlayerRatingModal
          ...
          isReservationOwner={ratingReservation.isOwner || false}
          onClose={() => {
