-- Örnek Tesisler ve Sahalar
-- Bu dosyayı PostgreSQL'de çalıştırarak örnek veriler ekleyebilirsiniz

-- Tesis 1: Beşiktaş Spor Kompleksi
INSERT INTO venues (name, description, city, district, address, phone, base_price_per_hour)
VALUES (
...
-- Tesis 1'in sahalarını eklemek için önce tesis ID'sini alalım
-- Not: Aşağıdaki sorgular çalıştırılırken venue_id değerlerini güncelleyin

-- Beşiktaş Spor Kompleksi - Saha A
INSERT INTO fields (venue_id, name, field_type, surface_type, has_lighting, has_roof, price_per_hour)
VALUES (
